...
def main():
    ...
    # 25개 자치구 목록
    districts = [
        "종로구 택시", "중구 택시", "용산구 택시", "성동구 택시", "광진구 택시", "동대문구 택시", "중랑구 택시", "성북구 택시", 
        "강북구 택시", "도봉구 택시", "노원구 택시", "은평구 택시", "서대문구 택시", "마포구 택시", "양천구 택시", "강서구 택시", 
        "구로구 택시", "금천구 택시", "영등포구 택시", "동작구 택시", "관악구 택시", "서초구 택시", "강남구 택시", "송파구 택시", "강동구 택시"
    ]
